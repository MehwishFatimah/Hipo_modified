...
DATASETS = [
    ("arxiv_val", PubmedDataset, {"file_path": "/hits/basement/nlp/fatimamh/inputs/pubmed-dataset/val.txt"}),
    ("arxiv_val_no_sections", PubmedDataset, {"file_path": "/hits/basement/nlp/fatimamh/inputs/pubmed-dataset/val.txt",
                                  "no_sections": True}),
]
EMBEDDERS = [
